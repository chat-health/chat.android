...
public class PageSelect1 {
    ...
    @DatabaseField
    private String zu_question1;
    @DatabaseField
    private String zu_answer1;
    @DatabaseField
    private String zu_answer2;
    @DatabaseField   
    private String zu_answer3;
    @DatabaseField
    private String zu_answer4;    
     ...
     */
    public PageSelect1(int id, String image1, String en_content1, String en_question1, String en_answer1, String en_answer2, String en_answer3, String en_answer4, String zu_content1, String zu_question1, String zu_answer1, String zu_answer2, String zu_answer3, String zu_answer4) {
    	this.id = id;
    	this.image1 = image1;
    ...
    public PageSelect1(PageSelect1 existingPageSelect1Model) {
        ...
        this.en_question1 = existingPageSelect1Model.en_question1;
        this.en_answer1 = existingPageSelect1Model.en_answer1;
        this.en_answer2 = existingPageSelect1Model.en_answer2;
        this.en_answer3 = existingPageSelect1Model.en_answer3;
        this.en_answer4 = existingPageSelect1Model.en_answer4;
        this.zu_content1 = existingPageSelect1Model.zu_content1;
        this.zu_question1 = existingPageSelect1Model.zu_question1;
        this.zu_answer1 = existingPageSelect1Model.zu_answer1;
        this.zu_answer2 = existingPageSelect1Model.zu_answer2;
        this.zu_answer3 = existingPageSelect1Model.zu_answer3;
        this.zu_answer4 = existingPageSelect1Model.zu_answer4;
    }
